      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left mb-6">
          ...
          <div className="mb-6 md:mb-0">
            <h2 className="text-3xl font-bold text-white">Ayandi Group</h2>
            <p className="mt-2 text-xl text-gray-500 max-w-xs">
              Leading the way in innovation and collaboration across multiple industries.
            </p>
          </div>

          {/* Quick Links */}
          <div className="flex space-x-6 mb-6 md:mb-0 text-xl">
          ...
          {/* Social Media Icons */}
          <div className="flex space-x-4 text-4xl text-gray-500">
        ...
        <div className="border-t border-gray-700 pt-6 text-center">
          <p className="text-lg text-gray-500">© 2024 Ayandi Group. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
